...
const Collection1 = ({ addToCart }) => {
  ...
  const holidayCandles = [
    // Autumn Collection
    {
      ...
      image: psb,
      shortDescription: 'Rich pumpkin with a warm, creamy spice.',
      longDescription: 'Sweet pumpkin blended with cinnamon, nutmeg, and a soft buttery aroma to create a cozy, autumnal atmosphere.',
      price: 19.99,
      notes: {
    ...
    },
    {
      ...
      image: ags,
      shortDescription: 'Crisp apple brightened with zesty ginger.',
      longDescription: 'Vibrant apple and subtle ginger notes combine with a sparkling, fruity aroma for a fresh, seasonal scent.',
      price: 19.99,
      notes: {
        top: 'Ginger, Clove, Anise',
        middle: 'Apple, Strawberry, Jasmine',
    ...
    },
    {
      ...
      image: bnb,
      shortDescription: 'Sweet butterscotch with a rich bourbon finish.',
      longDescription: 'Warm caramelized butterscotch paired with rich bourbon and subtle spices, perfect for an indulgent evening.',
      price: 19.99,
      notes: {
    ...
    },
    {
      ...
      name: 'Caramel Latté',
      image: clt,
      shortDescription: 'Coffee and caramel swirled together for a cozy scent.',
      longDescription: 'Rich coffee layered with sweet caramel and smooth vanilla, evoking the comforting aroma of a freshly made latté.',
      price: 19.99,
      notes: {
        top: 'Coffee',
        middle: 'Caramel, Sugar',
        base: 'Vanilla, Milk',
      },
      burnTime: '50-60 hours',
      size: '8 oz (227g)',
...
},
{
  ...
  return (
    <section style={sectionStyle}>
      <h1 style={headerStyle}>Previous Collections</h1>
      <div style={{
        display: 'flex',
